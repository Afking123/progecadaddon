...
# 定義來源和目的資料夾路徑
src_folder1 = os.path.join(current_working_directory, "test1")
dest_folder1 = os.path.join(appdata_roaming_path, "usertest")

src_folder2 = os.path.join(current_working_directory, "test2")
dest_folder2 = os.path.join(appdata_roaming_path, "usertest")
dest_folder3 = os.path.join(appdata_roaming_path, "usertest","font")
